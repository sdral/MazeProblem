...
class room1 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet("boy", "assets/boy_64x83.png", {
         ...
         this.load.image("thankyoupng","assets/thankyou.png")
         this.load.image("clockpng","assets/clock.png")
         this.load.image("earpng","assets/ear.png")
  ...
  //  var map = this.make.tilemap({key:'world'});
   var map = this.make.tilemap({key:'level2'});
    ...
    this.player.setCollideWorldBounds(true); // don't go out of the this.map
      ...
      this.npc2= this.physics.add.sprite(1050  ,1005,"npc3").setScale(1.6);
      this.npc2= this.physics.add.sprite(2200  ,1905,"npc4").setScale(1.6);

      this.key1 = this.physics.add.sprite(-1000, -1000, "keypng").setScale(0.5);
      this.thankyou = this.physics.add.sprite(800, 1100, "thankyoupng").setScale(2);
      this.clock = this.physics.add.sprite(500, 500, "clockpng").setScale(2);
      this.ear = this.physics.add.sprite(2200, 1150, "earpng").setScale(2);
